function GetNumberOfOffers(urlString, tabId, sendMessageToContentFunction) {
    ...
    var ajaxResponse = makeCorsGetRequest('http://affilatewebapplication20161111122930.azurewebsites.net/PriceCompare/GetSimilarProductsHtml', ajaxArgumentsArray, onGetNumberOfOffersSuccess, successArguments);
	return ajaxResponse;
}
